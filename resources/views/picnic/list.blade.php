                ...
                <div class="col-12">
                    <div class="card table-card">
                        <div class="card-header">
                            <h4>Picnic Table </h4><span style="float: right;"> <a href="{{route('addPicnic')}}" title="Add Picnic"  class="btn btn-primary"><i data-feather="plus-circle"></i> Add Picnic</a></span>
                        </div>
                        <div class="card-body">
